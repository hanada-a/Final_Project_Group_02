...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Public Health Information Management System");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        Organization authenticatedOrg = null;
        
        // Search through the ecosystem for the user
        ...
        if (userAccount == null || authenticatedOrg == null) {
            JOptionPane.showMessageDialog(this, 
                "Invalid username or password.\n\nAvailable test accounts:\n" +
                "Username: sarah.johnson | Password: Cdc@2024!\n" +
                "Username: christopher.lee | Password: Clinic@2024!", 
        ...
        // Update last login
        userAccount.setLastLogin(new java.util.Date());
        userAccount.resetFailedLoginAttempts();
        
        // Navigate to main screen
        JPanel mainScreen = new MainScreen(mainWorkArea, userAccount, authenticatedOrg, business);
